...
![Parameterized surface generated by evolving circles with different types of interpolation. (From left) linear, quadratic, cubic, which refers to the degree in $\alpha$ of the interpolation $C_\alpha'$. \cite[Fig. 8]{had}](Sections/evolved.jpg)
